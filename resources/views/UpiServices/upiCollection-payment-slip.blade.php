                    ...
                    <td>
                        ...
                        <table class="info-table">
                            <tr>
                                ...
                                <td class="value">{{ $payment->txn_id ?? '---' }}</td>
                            </tr>
                            <tr>
                                <td class="label">UTR:</td>
                                <td class="value">{{ $payment->utr ?? '---' }}</td>
                            </tr>
                        ...
                        <table class="info-table">
                            ...
                            <tr>
                                ...
                                <td class="value">₹{{ number_format($payment->fee ?? 0, 2) }}</td>
                            </tr>
                            <tr>
                                <td class="label">Tax:</td>
                                <td class="value">₹{{ number_format($payment->tax ?? 0, 2) }}</td>
                            </tr>
                            <tr>
                                <td class="label">Net Amount:</td>
                                <td class="value">₹{{ number_format($payment->net_amount ?? 0, 2) }}</td>
                            </tr>
                        </table>
                    ...
                    <td>
                        ...
                        <table class="info-table">
                            <tr>
                                ...
                                <td class="value">{{ $payment->cust_name ?? '---' }}</td>
                            </tr>
                            <tr>
                                <td class="label">Email:</td>
                                <td class="value">{{ $payment->cust_email ?? '---' }}</td>
                            </tr>
                            <tr>
                                <td class="label">Mobile:</td>
                                <td class="value">{{ $payment->cust_mobile ?? '---' }}</td>
                            </tr>
                            <tr>
                                <td class="label">Order ID:</td>
                                <td class="value">{{ $payment->connectpe_order_id ?? '---' }}</td>
                            </tr>
                            <tr>
                                <td class="label">Customer Txn ID:</td>
                                <td class="value">{{ $payment->cust_txn_id ?? '---' }}</td>
                            </tr>
                        </table>
                        ...
                        <table class="info-table">
                            <tr>
                                ...
                                <td class="value">{{ $payment->res_message ?? '---' }}</td>
                            </tr>
