...
@section('content')
    ...
    @if ($role == 1)
        ...
        <div class="row align-items-center border rounded p-2 shadow-sm">
            ...
            <div class="col">
                <!-- Profile Image -->
                <img id="userImage" src="path/to/user-image.jpg" alt="User Image"
                    class="rounded-circle border border-1 border-primary" width="100" height="100"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between border rounded p-3">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm"
                                                onclick="showImage('','Bank Document')">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="e.g. Retail, IT, Manufacturing" name="industry">
                                </div>
