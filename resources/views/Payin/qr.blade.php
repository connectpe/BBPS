...
<body
    ...
    <div class="w-full max-w-5xl">
        ...
        <div id="payment-card"
                        ...
                        <div id="expiry-warning-banner"
                            ...
                            <div class="flex gap-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 text-rose-600 flex-shrink-0 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="relative bg-white rounded-3xl p-5 border border-slate-200 shadow-lg">
                            ...
                            <div id="qr-expired-overlay"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-rose-400 mb-2"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333-.77 2.694 3.464 3z" />
            ...
            <div id="payment-success" class="hidden">
                ...
                <div class="px-6 sm:px-8 lg:px-10 py-14 sm:py-16 text-center">

                    <div class="w-20 h-20 mx-auto rounded-full bg-emerald-100 flex items-center justify-center">

                        <svg xmlns="http://www.w3.org/2000/svg" class="w-11 h-11 text-emerald-600" fill="none"
                    ...
                    <p class="text-xs font-bold uppercase tracking-widest text-emerald-600 mt-6">
                        Payment Completed
                    </p>
                    ...
                    <div class="mt-6 text-4xl sm:text-5xl font-black text-emerald-600">
                        ₹<span id="success-amount"></span>
                    </div>


                    <div
                        class="mt-6 inline-flex flex-col items-center bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4">

                        <span class="text-[11px] font-semibold uppercase tracking-wider text-slate-400">
                            Client Reference ID
                        </span>

                        <span id="success-transaction"
                            class="font-mono text-xs font-bold text-slate-700 mt-1 break-all">
                        </span>
            ...
            <div id="payment-failed" class="hidden">
                ...
                <div class="px-6 sm:px-8 lg:px-10 py-14 sm:py-16 text-center">
                    ...
                    <div class="w-20 h-20 mx-auto rounded-full bg-rose-100 flex items-center justify-center">

                        <svg xmlns="http://www.w3.org/2000/svg" class="w-11 h-11 text-rose-600" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="text-xs font-bold uppercase tracking-widest text-rose-600 mt-6">
                        Payment Failed
                    </p>
                    ...
                    <div
                        class="mt-6 inline-flex items-center gap-2 bg-rose-50 border border-rose-100 rounded-xl px-4 py-3">
                        ...
                        <span class="text-xs font-semibold text-rose-700">
                            Please contact support if the amount was debited.
                        </span>
        ...
        <div class="flex items-center justify-center gap-2 mt-5 text-slate-400">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-emerald-400" fill="none"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M12 15v2m-6 4h12a2 2 0 002-2v-7a2 2 0 00-2-2H6a2 2 0 002-2 2 2 0 002 2z" />
    ...
    <script>
        ...
        const qrExpiredOverlay =
            document.getElementById("qr-expired-overlay");

        const expiryWarningBanner =
            document.getElementById("expiry-warning-banner");

        const defaultInstruction =
            document.getElementById("default-instruction");
        ...
        function checkPaymentStatus() {
            $.ajax({
                url: "{{ route('payin.qr.status', ['clientRefId' => $transaction->cust_txn_id]) }}",
                type: "GET",
        ...
        function showPaymentSuccess(data) {
            ...
            document.getElementById('success-transaction')
                .textContent =
        ...
        function showPaymentFailed(data) {
            ...
            document.getElementById('failed-transaction')
                .textContent =
                data.transaction_id ?? txnId;
