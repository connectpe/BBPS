        ...
        <div class="col-md-12">
            <div class="card shadow-sm h-100">
                <img src="{{ asset('assets/image/Logo/bharat-connect-logo.jpg') }}" alt=""
                    class="position-absolute top-0 end-0 m-2" style="width: 70px;">
                <div class="card-body position-relative mt-1 mt-5">
                        ...
                        @foreach ($services as $service)
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-3 text-center mb-3">
                                <a href="javascript:void(0)"
                                    class="text-decoration-none text-dark d-flex flex-column align-items-center utility-service-btn"
                    ...
                    <div class="card-body d-flex flex-column">
                        <form class="row g-3 flex-grow-1">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="search_categroy"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header position-relative">
                    ...
                    <img src="{{ asset('assets/image/Logo/bharat-connect-logo.jpg') }}" alt=""
                        class="position-absolute" style="top: 10px; right: 50px; width: 70px;">
                    <button type="button" class="btn-close position-absolute bg-light" data-bs-dismiss="modal"
                        style=" right: 18px;"></button>
                </div>
