            ...
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body">
                    ...
                    <div class="info-row">
                        ...
                        <span
                            class="value">{{ $businessInfo?->itr_filled == '1' ? 'Yes' : ($businessInfo?->itr_filled == '0' ? 'No' : '----') }}</span>
                    </div>
                            ...
                            <div class="d-flex flex-column gap-1">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <input type="number" step="0.01" min="0"
                                        class="form-control form-control-sm" id="setupCostInput"
                                        value="{{ $userData->setup_cost ?? 0 }}" style="width:90px;">
                        ...
                        @php
                            $docs = [
                                ...
                                [
                                    ...
                                    'file' => $businessInfo->registration_certificate_image ?? '',
                                ],
                                [
                                    'label' => 'GST Certificate',
                                    'file' => $businessInfo->gst_registration_certificate_image ?? '',
                                ],
                                [
                                    'label' => 'Business Address',
                                    'file' => $businessInfo->business_address_proof_image ?? '',
                                ],
    ...
    <script>
        $(document).ready(function() {
                ...
                $.get(`/admin/services/${serviceId}/providers`, {
                    ...
                    <li class="p-1">
                        <div class="form-check">
                            <input class="form-check-input provider-chk" type="radio" name="provider_id" 
                                value="${p.id}" id="p_${p.id}" data-name="${p.name}" data-slug="${p.slug}" ${isChecked}>
            ...
            $("#routingForm").on("submit", function(e) {
                ...
                const providerId = $("input[name='provider_id']:checked").val();
                const providerSlug = $("input[name='provider_id']:checked").data('slug');
                const submitBtn = $(this).find("button[type='submit']");

                if (!serviceId || !providerId) {
                    alert("Select both service and provider.");
                    return;
                }
