...
<head>
    ...
    <style>
        ...
        .container { width: 100%; border: 1px solid #e5e5e5; padding: 20px; margin: 0 auto; }
        .header { font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 25px; text-transform: uppercase; color: #222; }
        
        /* Top Header Table */
        .brand-table { width: 100%; margin-bottom: 30px; border-bottom: 2px solid #f0f0f0; padding-bottom: 15px; }
        .brand-left { width: 50%; vertical-align: middle; }
        .brand-right { width: 50%; text-align: right; vertical-align: middle; }
        .brand-logo { font-size: 22px; font-weight: 800; color: #0d6efd; letter-spacing: 1px; }
        .business-info { font-size: 11px; color: #555; }
        .business-name { font-size: 14px; font-weight: bold; color: #000; display: block; margin-bottom: 2px; }

        /* Sections */
        .section-title { font-weight: bold; font-size: 13px; margin-bottom: 10px; border-bottom: 1px solid #eee; padding-bottom: 5px; color: #555; text-transform: uppercase; }
        .row-table { width: 100%; margin-bottom: 20px; }
        .col-cell { width: 50%; vertical-align: top; padding-right: 10px; }
        .item { margin-bottom: 8px; }
        .label { color: #777; display: inline-block; width: 110px; }
        .value { font-weight: 600; color: #333; }
        .status { color: #28a745; font-weight: bold; text-transform: capitalize; }

        /* Amount & Footer */
        .amount-box { background: #f8f9fa; padding: 10px; border-radius: 4px; }
        .amount-value { font-size: 20px; font-weight: bold; color: #0d6efd; }
        .footer-note { margin-top: 30px; text-align: center; font-size: 10px; color: #999; border-top: 1px solid #eee; padding-top: 10px; }
    </style>
</head>
<body>
            ...
            <tr>
                <td class="col-cell">
                    ...
                    <div class="item">
                        ...
                        <span class="value">{{ $txn->reference_number ?? '-' }}</span>
                    </div>
                    <div class="item">
