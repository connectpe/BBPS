            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
               <div class="card shadow-sm h-100 d-flex flex-column justify-content-center">
                        ...
                        <div style=" height:150px; display:flex; align-items:center; justify-content:center;">
                            ...
                            @if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                <img src="{{ FileUpload::getFilePath($agreement->file_path) }}"
                                    style="max-height:100%; width:100%; object-fit:cover; border-radius:8px;">
                            @elseif($ext == 'pdf')
                    ...
                    <div class="card-footer text-center bg-white mt-auto">
                        <a href="{{ FileUpload::getFilePath($agreement->file_path) }}" target="_blank"
                            class="btn btn-sm buttonColor me-1">
                            <i class="fa-solid fa-eye"></i>
                        </a>

                        <a href="{{ FileUpload::getFilePath($agreement->file_path) }}" download
