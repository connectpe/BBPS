        ...
        <div class="modal-content">
            ...
            <div class="modal-header position-relative overflow-visible">
                ...
                <img src="{{ asset('assets/image/Logo/bharat-connect-logo.jpg') }}" alt=""
                    class="position-absolute" style="top: 10px; right: 50px; width: 100px; z-index: 1060;">
...
<!-- complaint success swal commented -->
<!-- <script>
    ...
    $('#complaintForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                let refId = res.ref_id ?? 'PAY1777444302549';
                let complaintId = res.complaint_id ?? '#16785779836';
                let txnID = res.txn_id ?? 'TXN1777444302466';
                    ...
                    html: `
                        ...
                        ">
                             ...
                             Your Complaint has been registered successfully
                                for Bharat-Connect Transaction Ref ID
                                <b>${refId}</b>.

                                <br><br>

                                You can track Complaint by Complaint ID
                                <b>${complaintId}</b>.
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, row, type) {
                        const status = data == 'Low' ? 'success' : (data == 'High' ? 'danger' :
                            'warning');
