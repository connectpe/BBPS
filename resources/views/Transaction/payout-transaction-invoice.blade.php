...
<body>
    <div class="invoice-box">
        <table class="header-table">
            <tr>
                <td class="brand-name">
                    <img src="{{ app()->environment('local') ? public_path('assets/image/Logo/b-assured-logo.jpg') : asset('assets/image/Logo/b-assured-logo.jpg') }}"
        ...
        <table class="txn-info-table">
            ...
            <tr>
                <td>{{ $order->contact->account_number ?? '---' }}</td>
                <td>{{ $order->contact->account_ifsc ?? '---' }}</td>
