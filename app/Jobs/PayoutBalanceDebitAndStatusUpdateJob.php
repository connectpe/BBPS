            ...
            if ($this->call == 'balance_debit') {
                ...
                if (isset($OrderData) && !empty($OrderData)) {
                    ...
                    if (empty($defaultSlugData)) {
                        $defaultSlugData = UserRooting::select('provider_slug')->where(['user_id' => $userId, 'service_id' => $this->serviceId])->first();
                    }
                    ...
                    $lockeOrder = TransactionHelper::moveOrderToProcessingByOrderId($OrderData->user_id, $OrderData->transaction_no, $integrationId);
