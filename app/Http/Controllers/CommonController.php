    ...
    public function fetchData(Request $request, $type, $id = 0, $returnType = 'all')
    {
        ...
        switch ($type) {
            ...
            case 'support-based-user-list':
                ...
                if (Auth::user()->role_id == '1') {
                    $request['whereIn'] = 'assined_to';
                    $request['parentData'] = $request['assined_to'];
                } else {
                    $request['whereIn'] = 'assined_to';
                    $request['parentData'] = [Auth::user()->id];
                }
        ...
        $filterColumnsMap = [
            ...
            'orders' => ['connectpe_id', 'order_ref_id', 'client_ref_id', 'utr_no', 'mode', 'status', 'user_id', 'provider_id'],
        ...
        // if (isset($request->searchText) && ! empty($request->searchText) && $type == '
        // ') {
