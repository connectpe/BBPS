...
<ul class="sidebar-menu">
    ...
    @php
        ...
        $userRoute = ['users','associates','view_user','request_services','support_details','load_money_request'];
        ...
        $upiRoute = ['upi_initiation','upi_collection','all_upi_transactions','api_callback','upi_manual_settlement'];
    ...
    {{-- User Management --}}
    <li>
        <a class="nav-link {{ $userActive ? 'active' : '' }}" data-bs-toggle="collapse" href="#userManagement">
        ...
        <div class="collapse submenu {{ $userActive ? 'show' : '' }}" id="userManagement">
           <a href="{{ route('users') }}"  class="nav-link {{ Route::currentRouteName() == 'users' ? 'active' : '' }}"><i class="bi bi-person-lines-fill"></i><span class="menu-text">Users</span></a>
            <a href="{{ route('associates') }}" class="nav-link {{ Route::currentRouteName() == 'associates' ? 'active' : '' }}"><i class="fa-solid fa-handshake"></i><span class="menu-text">Associated Partners</span></a>

            <a href="{{ route('request_services') }}" class="nav-link d-flex justify-content-between align-items-center {{ Route::currentRouteName() == 'request_services' ? 'active' : '' }}">
            ...
            <a href="{{ route('support_details') }}" class="nav-link {{ Route::currentRouteName() == 'support_details' ? 'active' : '' }}"><i class="bi bi-person-plus-fill"></i><span class="menu-text">Support User</span></a>
            <a href="{{ route('load_money_request') }}" class="nav-link {{ Route::currentRouteName() == 'load_money_request' ? 'active' : '' }}"><i class="bi bi-wallet2"></i><span class="menu-text">Load Money</span></a>
        </div>
    </li>
    ...
    {{-- Transactions --}}
    <li>
        <a class="nav-link {{ $transactionActive ? 'active' : '' }}" data-bs-toggle="collapse" href="#transactionManagement">
        ...
        <div class="collapse submenu {{ $transactionActive ? 'show' : '' }}" id="transactionManagement">
            <a href="{{ url('reports/recharge') }}" class="nav-link {{ Route::currentRouteName() == 'recharge' ? 'active' : '' }}"><i class="bi bi-phone"></i><span class="menu-text">Recharge</span></a>
            <a href="{{ url('reports/banking') }}" class="nav-link {{ Route::currentRouteName() == 'banking_service' ? 'active' : '' }}"><i class="bi bi-bank"></i><span class="menu-text">Banking</span></a>
            <a href="{{ url('reports/utility') }}" class="nav-link {{ Route::currentRouteName() == 'utility_service' ? 'active' : '' }}"><i class="bi bi-lightning-charge"></i><span class="menu-text">Utility</span></a>
            <a href="{{ route('payout_transaction') }}" class="nav-link {{ Route::currentRouteName() == 'payout_transaction' ? 'active' : '' }}"><i class="bi bi-arrow-left-right"></i><span class="menu-text">Payout Transaction</span></a>
        </div>
    </li>
    ...
    {{-- Reports --}}
    <li>
        <a class="nav-link {{ $reportActive ? 'active' : '' }}" data-bs-toggle="collapse" href="#reportRoute">
        ...
        <div class="collapse submenu {{ $reportActive ? 'show' : '' }}" id="reportRoute">
            <a href="{{ route('complain.report') }}" class="nav-link {{ Route::currentRouteName() == 'complain.report' ? 'active' : '' }}"><i class="bi bi-file-earmark-text"></i><span class="menu-text">Complaint</span></a>
            <a href="{{ route('api_log') }}" class="nav-link {{ Route::currentRouteName() == 'api_log' ? 'active' : '' }}"><i class="bi bi-journal-text"></i><span class="menu-text">API Log</span></a>
        </div>
    </li>
    ...
    <li>
        ...
        <div class="collapse submenu {{ $upiActive ? 'show' : '' }}" id="upiServices">
            <a href="{{ route('upi_initiation') }}" class="nav-link {{ Route::currentRouteName() == 'upi_initiation' ? 'active' : '' }}"><i class="bi bi-arrow-up-right-circle"></i><span class="menu-text">UPI Initiation</span></a>
            <a href="{{ route('upi_collection') }}" class="nav-link {{ Route::currentRouteName() == 'upi_collection' ? 'active' : '' }}"><i class="bi bi-plus-circle"></i><span class="menu-text">UPI Collection</span></a>
            <a href="{{ route('all_upi_transactions') }}" class="nav-link {{ Route::currentRouteName() == 'all_upi_transactions' ? 'active' : '' }}"><i class="bi bi-list-check"></i><span class="menu-text">All Transactions</span></a>
            <a href="{{ route('upi_callback') }}" class="nav-link {{ Route::currentRouteName() == 'upi_callback' ? 'active' : '' }}"><i class="bi bi-arrow-repeat"></i><span class="menu-text">UPI Callback</span></a>
            <a href="{{ route('upi_manual_settlement') }}" class="nav-link {{ Route::currentRouteName() == 'upi_manual_settlement' ? 'active' : '' }}"><i class="bi bi-wallet2"></i><span class="menu-text">Manual Settlement</span></a>
        </div>
    </li>
    ...
    {{-- Master Settings --}}
    <li>
        <a class="nav-link {{ $masterActive ? 'active' : '' }}" data-bs-toggle="collapse" href="#masterRoute">
        ...
        <div class="collapse submenu {{ $masterActive ? 'show' : '' }}" id="masterRoute">
            <a href="{{ route('our_servicess') }}" class="nav-link {{ Route::currentRouteName() == 'our_servicess' ? 'active' : '' }}"><i class="bi bi-briefcase"></i><span class="menu-text">Our Services</span></a>
            <a href="{{ route('providers') }}" class="nav-link {{ Route::currentRouteName() == 'providers' ? 'active' : '' }}"><i class="bi bi-person-badge"></i><span class="menu-text">Providers</span></a>
            <a href="{{ route('categories.index') }}" class="nav-link {{ Route::currentRouteName() == 'categories.index' ? 'active' : '' }}"><i class="bi bi-tags"></i><span class="menu-text">Categories</span></a>
            <a href="{{ route('defaultslug') }}" class="nav-link {{ Route::currentRouteName() == 'defaultslug' ? 'active' : '' }}"><i class="bi bi-link-45deg"></i><span class="menu-text">Default Provider</span></a>
            <a href="{{ route('business_category') }}" class="nav-link {{ Route::currentRouteName() == 'business_category' ? 'active' : '' }}"><i class="bi bi-grid"></i><span class="menu-text">Business Category</span></a>
        </div>
    </li>


    {{-- Single Links --}}
    <li><a href="{{ route('schemes.index') }}" class="nav-link {{ Route::currentRouteName() == 'schemes.index' ? 'active' : '' }}"><i class="bi bi-diagram-3"></i><span class="menu-text">Schemes</span></a></li>
    <li><a href="{{ route('user_assign_to_support') }}" class="nav-link {{ Route::currentRouteName() == 'user_assign_to_support' ? 'active' : '' }}"><i class="bi bi-person-check"></i><span class="menu-text">Assign User</span></a></li>
    <li><a href="{{ route('nsdl-payment') }}" class="nav-link {{ Route::currentRouteName() == 'nsdl-payment' ? 'active' : '' }}"><i class="bi bi-receipt"></i><span class="menu-text">NSDL Payment</span></a></li>
...
<ul class="sidebar-menu">
    ...
    <li>
        <a class="nav-link {{ $userActive ? 'active' : '' }}"
            data-bs-toggle="collapse" href="#userManagement">
            <i class="bi bi-people"></i>
 ...
 <ul class="sidebar-menu">
    ...
    <li>
        <a class="nav-link {{ $transactionActive ? 'active' : '' }}"
            data-bs-toggle="collapse" href="#transactionManagement">
            <i class="bi bi-cash-stack"></i>
            <span class="menu-text">Transactions</span>
            <i class="bi bi-chevron-down submenu-arrow"></i>
        </a>
